...
namespace TicketSysteemMVC5.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        // GET: /Manage/Index
        /// <summary>
        /// Stuurt de gebruiker door naar Profiel
        /// </summary>
        /// <returns>Profiel via Account/Profiel</returns>
        ...
        /// </summary>
        /// <param name="model">Model met Oud en Nieuw Wachtwoord</param>
            ...
            if (result.Succeeded)
            {
                ...
                if (user != null)
                {
                    if (user.ChangePassword)
                    {
                        ...
                        gebruiker.ChangePassword = false;
